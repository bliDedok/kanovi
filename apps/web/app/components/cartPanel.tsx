...
export function CartPanel({ items, totalPrice }: CartPanelProps) {
  ...
  return (
    <div style={{ 
      width: '380px', 
      backgroundColor: '#1e1611', // Cokelat gelap sesuai tema Dashboard
      color: '#f3ece7', 
      padding: '24px', 
      display: 'flex', 
      ...
      <h2 style={{ 
        ...
        fontWeight: '600', 
        marginBottom: '24px', 
        color: '#d4a373', // Warna aksen cokelat muda
        display: 'flex',
        alignItems: 'center',
        gap: '10px'
      }}>
        ...
        {items.length === 0 ? (
          ...
          items.map((item) => (
            <div key={item.id} style={{ 
              ...
              marginBottom: '12px', 
              padding: '16px', 
              backgroundColor: 'rgba(212, 163, 115, 0.1)', // Transparansi cokelat
              borderRadius: '12px',
