...
export default function POSPage() {
  ...
  // === FUNGSI KONFIRMASI HAPUS KERANJANG ===
  ...
  const filteredMenus = (Array.isArray(menus) ? menus : []).filter(menu => menu.name.toLowerCase().includes(searchQuery.toLowerCase()));
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-kanovi-paper dark:bg-kanovi-darker rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-kanovi-cream/50 dark:border-white/5 relative">
            ...
            <p className="text-sm text-kanovi-coffee/70 dark:text-kanovi-cream/70 text-center mb-6">
              Semua pesanan yang sudah diinput akan dihapus dan tidak bisa dikembalikan.
            </p>
      ...
      {isCashModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-kanovi-paper dark:bg-kanovi-darker rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-kanovi-cream/50 dark:border-white/5 relative">
            ...
            <button onClick={handleConfirmCash} disabled={!isEnough || cashNum === 0} className="w-full py-4 bg-kanovi-wood hover:bg-kanovi-coffee text-white font-bold rounded-xl shadow-md disabled:opacity-50 transition-colors">Selesaikan Pembayaran</button>
          </div>
        </div>
      )}
      ...
      {isQrisModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-kanovi-paper dark:bg-kanovi-darker rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-kanovi-cream/50 dark:border-white/5 relative">
            ...
            <button onClick={handleConfirmQris} className="w-full py-4 bg-kanovi-wood hover:bg-kanovi-coffee text-white font-bold rounded-xl shadow-md transition-colors">
